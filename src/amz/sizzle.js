 ...
 * @name amz.query
 * @function
 * @grammar amz.query(selector[, context[, results]])
 ...
 */
 ...
 //在用户选择使用 Sizzle 时会被覆盖原有简化版本的amz.query方法

    amz.query = function(selector, context, results) {
        return amz.merge(results || [], amz.sizzle(selector, context));
    };
...
window.Sizzle = amz.sizzle = Sizzle;
