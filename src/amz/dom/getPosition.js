...
///import amz.dom.getComputedStyle;
 ...
 * @create 2013-3-3
 * @function
 * @name amz.dom.getPosition
 * @grammar amz.dom.getPosition( element )
 * @param {HTMLElement} element DOM元素
 * @return {top, left} 元素的座标
 */
amz.dom.getPosition = function( element ) {
    element = amz.dom(element);
    var doc = amz.dom.getDocument(element), 
        browser = amz.browser,
        getStyle = amz.dom.getComputedStyle,
...
// TODO: 添加坐标运算的起始点，即相对于某元素的偏移量 2013.3.11